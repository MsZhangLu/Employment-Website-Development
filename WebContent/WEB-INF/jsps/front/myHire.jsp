							...
							<div class="row">
								...
								<div class="col-lg-8 col-sm-8">
									<ol class="breadcrumb pull-right">
										<li><a
											href="${pageContext.request.contextPath }/user/resumeQuery?userid=${user.id}"><i
												class="icon-bell"></i><strong>
													&nbsp;&nbsp;&nbsp;收到的简历</strong></a></li>
									</ol>
								</div>
							</div>
									...
									<table class="table table-striped border-top" id="">
										<thead>
											<tr>
												...
												<th class="hidden-phone">人数</th>
												<th class="hidden-phone">薪酬</th>
												<th class="hidden-phone">区域</th>
												<th></th>
												<th></th>
											</tr>
										</thead>
										...
										<tbody>
											<c:forEach items="${myHireList }" var="my" varStatus="status">
												<tr class="odd gradeX">
													<td>${status.index + 1 }</td>
													<td class="hidden-phone"><a
														href="${pageContext.request.contextPath }/user/myHireDetail.action?jobid=${my.id}">${my.job_name}</a></td>
													<td class="hidden-phone">${my.job_type_name}</td>
													<td class="hidden-phone">${my.job_amount}</td>
													<td class="hidden-phone">${my.job_pay}</td>
													<td class="hidden-phone">${my.district_name}</td>
													<td><a
														href="${pageContext.request.contextPath }/user/editJob.action?jobid=${my.id}">
															<button class="btn btn-primary btn-xs">
																<i class="icon-pencil">修改</i>
															</button>
													</a> <a
														href="${pageContext.request.contextPath }/user/jobDelete.action?jobid=${my.id}&userid=${user.id}"
														id="jobDelete">
